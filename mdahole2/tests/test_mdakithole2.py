...
def rlimits_missing():
    ...
    try:
        # on Unix we can manipulate our limits:
...
class TestHole(object):
    ...
    def test_correct_input(self, tmpdir):
        ...
        #  trailing whitespace after CL is required
    ...
    def test_input_options(self, tmpdir):
        ...
        #  trailing whitespace after IGNORE is required
        hole_input = textwrap.dedent("""
            RADIUS simple2.rad
            SPHPDB hole.sph
            SAMPLE 0.200000
    ...
    #         profiles = hole(filename, random_seed=self.random_seed, dcd=DCD,
    #                               dcd_iniskip=skip,
...
class TestHoleAnalysis(BaseTestHole):
    ...
    def test_plot(self, hole, frames, profiles):
        ...
        err_msg = "hole.HoleAnalysis.plot() did not produce an Axes instance"
    ...
    def test_plot_mean_profile(self, hole, frames, profiles):
        ...
        #  making sure that we have equidistrant bins
        assert_allclose(binwidths, binwidth)
    ...
    def test_plot3D(self, hole, frames, profiles):
        ...
        err_msg = "hole.HoleAnalysis.plot3D() did not produce an Axes3D instance"
    ...
    def test_plot3D_rmax(self, hole, frames, profiles):
        ...
        err_msg = "hole.HoleAnalysis.plot3D(rmax=float) did not produce an Axes3D instance"
        assert isinstance(ax, mpl_toolkits.mplot3d.Axes3D), err_msg
...
class TestHoleAnalysisLong(BaseTestHole):
    ...
    def test_plot_order_parameters(self, hole, order_parameter_keys_values,
        ...
        err_msg = ("hole.HoleAnalysis.plot_order_parameters()"
    ...
    def test_plot3D_order_parameters(self, hole, order_parameter_keys_values):
        ...
        err_msg = ("hole.HoleAnalysis.plot3D_order_parameters() "
...
class TestHoleModule(object):
    ...
    def test_hole_module_fd_closure(self, universe, tmpdir):
        ...
        # Hasten failure by setting "ulimit -n 64" (can't go too low because of
        # open modules etc...)
        import resource
        ...
        with tmpdir.as_cwd():
            ...
            try:
                ...
                if err.errno == errno.EMFILE:
                    raise pytest.fail(
                        "hole.HoleAnalysis does not close file descriptors (Issue 129)")
                raise
            finally:
